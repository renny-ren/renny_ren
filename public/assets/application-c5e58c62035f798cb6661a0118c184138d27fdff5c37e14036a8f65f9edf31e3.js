...
(function(g) {
  ...
  g.fn.jR3DCarousel = function(y) {
    ...
    var a = g.extend(!0, {}, {
      ...
      w = new x,
      q, r, v, f, c = 0,
      e, k, p, b = a.slides.length || d.find("." + a.slideClass).length;
    (function() {
      function F() {
        ...
        g(document).on("keydown", function(a) {
          ...
          (b = 0 < b.bottom && 0 < b.right && b.left < (innerWidth || document.documentElement.clientWidth) && b.top < (innerHeight || document.documentElement.clientHeight)) && 37 == a.which ? (clearInterval(v), q.click()) : b && 39 == a.which && (clearInterval(v), r.click())
        });
        u(d, function(b) {
          clearInterval(v);
      ...
      function x() {
        for (var f = a.navigation, e = g("<div class=navigation />").css({
          position: "absolute",
          bottom: 0,
          right: 0
  ...
  Typed.prototype = {
    ...
    backspace: function(curString, curStrPos) {
      ...
      self.timeout = setTimeout(function() {
        ...
        // if the number (id of character in current string) is less than the stop number, keep going
        ...
        // if the stop number has been reached, increase array position to next string
